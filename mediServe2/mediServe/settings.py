...
CELERY_TIMEZONE = 'UTC'
WHATSAPP_MODE = os.getenv('WHATSAPP_MODE', 'sandbox')
TWILIO_ACCOUNT_SID = os.getenv('TWILIO_ACCOUNT_SID')
TWILIO_AUTH_TOKEN = os.getenv('TWILIO_AUTH_TOKEN')
TWILIO_VERIFY_SID = os.getenv('TWILIO_VERIFY_SID')
TWILIO_SMS_NUMBER = os.getenv('TWILIO_SMS_NUMBER', '+16065955879')
TWILIO_WHATSAPP_NUMBER = os.getenv('TWILIO_WHATSAPP_NUMBER')
GEMINI_API_KEY = os.getenv('GEMINI_API_KEY', "AIzaSyC0Gv3kJLk9M4sIDv0zM581sNnhXwFpaKE")
...
if WHATSAPP_MODE == 'production':
    # En production : utiliser votre numéro WhatsApp Business approuvé
    TWILIO_WHATSAPP_NUMBER = os.getenv('TWILIO_WHATSAPP_NUMBER_PROD', '+16065955879')
    WHATSAPP_SANDBOX_CODE = None
    WHATSAPP_REQUIRES_OPTIN = False  # Pas besoin de "join" en production
else:
    # En sandbox : utiliser le numéro sandbox de Twilio
    TWILIO_WHATSAPP_NUMBER = '+14155238886'
    WHATSAPP_SANDBOX_CODE = os.getenv('WHATSAPP_SANDBOX_CODE', 'fur-asleep')
    WHATSAPP_REQUIRES_OPTIN = True

WHATSAPP_TEMPLATES = {
    'activation': os.getenv('WHATSAPP_TEMPLATE_ACTIVATION', 'activation_template'),
    'document_ready': os.getenv('WHATSAPP_TEMPLATE_DOCUMENT', 'document_ready_template'),
    'appointment_reminder': os.getenv('WHATSAPP_TEMPLATE_APPOINTMENT', 'appointment_template'),
}
