...
export default function ReportsPage() {
  ...
  useEffect(() => {
    async function loadReports() {
      ...
      setStats({
        totalPatients: patientStats.total_count || 0,
        appointmentsThisMonth: sessionStats.total_sessions || 0,
        satisfactionRate: metrics.delivery_success_rate || 0,
        whatsappMessages: sessionStats.total_sessions || 0,
        newPatientsThisMonth: 0, // Placeholder
        retentionRate: 0, // Placeholder
        averageAge: 0, // Placeholder
        showRate: 0, // Placeholder
        cancellationRate: 0, // Placeholder
        averageDuration: 0, // Placeholder
        responseRate: 0, // Placeholder
        averageResponseTime: sessionStats.avg_response_time_ms || 0,
        connectedPatients: sessionStats.active_sessions || 0,
      })
      setLoading(false)
    }
    loadReports()
        ...
        <TabsContent value="overview" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{loading ? "..." : stats.appointmentsThisMonth}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{loading ? "..." : `${stats.satisfactionRate}%`}</div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="text-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    <div className="text-2xl font-bold text-blue-600">{loading ? "..." : stats.newPatientsThisMonth}</div>
                    <div className="text-sm text-muted-foreground">Nouveaux patients ce mois</div>
                  </div>
                  <div className="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                    <div className="text-2xl font-bold text-green-600">{loading ? "..." : `${stats.retentionRate}%`}</div>
                    <div className="text-sm text-muted-foreground">Taux de rétention</div>
                  </div>
                  <div className="text-center p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                    <div className="text-2xl font-bold text-orange-600">{loading ? "..." : stats.averageAge}</div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="text-center p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                    <div className="text-2xl font-bold text-purple-600">{loading ? "..." : `${stats.showRate}%`}</div>
                    <div className="text-sm text-muted-foreground">Taux de présence</div>
                  </div>
                  <div className="text-center p-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
                    <div className="text-2xl font-bold text-red-600">{loading ? "..." : `${stats.cancellationRate}%`}</div>
                    <div className="text-sm text-muted-foreground">Taux d'annulation</div>
                  </div>
                  <div className="text-center p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                    <div className="text-2xl font-bold text-yellow-600">{loading ? "..." : `${stats.averageDuration}min`}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="text-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                    <div className="text-2xl font-bold text-green-600">{loading ? "..." : `${stats.responseRate}%`}</div>
                    <div className="text-sm text-muted-foreground">Taux de réponse</div>
                  </div>
                  <div className="text-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    <div className="text-2xl font-bold text-blue-600">{loading ? "..." : `${stats.averageResponseTime}ms`}</div>
                    <div className="text-sm text-muted-foreground">Temps de réponse moyen</div>
                  </div>
                  <div className="text-center p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                    <div className="text-2xl font-bold text-orange-600">{loading ? "..." : stats.connectedPatients}</div>
