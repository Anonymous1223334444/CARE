...
export default function AppointmentsPage() {
  ...
  useEffect(() => {
    async function loadAppointments() {
      ...
      const appointmentData = activePatients.map((patient: any, index: number) => ({
        id: index,
      ...
      setStats({
        today: sessionStats.conversations_24h || 0,
        week: sessionStats.total_sessions || 0,
        pending: 0, // API does not provide this stat
      })
      setLoading(false)
    }
    loadAppointments()
